                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <span class="label label-primary" id="totaljumlah"></span>
                            </div>
                        </div>
                        ...
                        <div class="box-body no-padding">
                            <table class="table table-condensed" id="addDesignator">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 214px; text-align: center;"><input style="text-align: center;" class="form-control jumlah" type="text" name="jumlah" id="jumlah0" readonly="readonly"  value="0"/></td>
