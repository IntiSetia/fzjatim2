      ...
      foreach ($data_hr as $a) {
          ...
          <div class="content-wrapper">
              ...
              <section class="content-header">
                  ...
                  <ol class="breadcrumb">
                      <li><a href="<?= base_url('index.php/hrperformance/') ?>"><i class="fa fa-angle-left"></i> Kembali</a>
                      </li>
                  </ol>
              </section>
              ...
              <section class="content">
                  ...
                  <div class="row">
                      <div class="col-md-3">
                          ...
                          <a href="<?= base_url('index.php/hrperformance/view_edit/' . $a['nik']) ?>"
                             class="btn btn-primary btn-block"><b>Edit Data Profile</b></a>
                              ...
                              <div class="tab-content">
                                  <div class="active tab-pane" id="activity">
                                      <form class="form-horizontal" method="POST"
                                            action="<?= base_url('index.php/HrPerformance/edit/') ?>">
                                          <div class="box-body">
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="object_id"
                                                             value="<?= $a['object_id']; ?>" class="form-control"
                                                             id="inputEmail3" placeholder="Object Id" readonly
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="nik" value="<?= $a['nik']; ?>"
                                                             class="form-control" id="inputEmail3" placeholder="NIK"
                                                             readonly="NIK"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="nama" value="<?= $a['nama']; ?>"
                                                             class="form-control" id="inputPassword3" placeholder="Nama"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="psa" value="<?= $a['psa']; ?>"
                                                             class="form-control" id="inputPassword3" placeholder="PSA"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="witel" value="<?= $a['witel']; ?>"
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="teritory" value="<?= $a['teritory']; ?>"
                                                             class="form-control" id="inputPassword3"
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="regional" value="<?= $a['regional']; ?>"
                                                             class="form-control" id="inputPassword3"
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="level" value="<?= $a['level']; ?>"
                                                             class="form-control" id="inputPassword3"
                                                             placeholder="Level"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="bizpart_id"
                                                             value="<?= $a['bizpart_id']; ?>" class="form-control"
                                                             id="inputPassword3" placeholder="Bizpart Id"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="direktorat"
                                                             value="<?= $a['direktorat']; ?>" class="form-control"
                                                             id="inputPassword3" placeholder="Direktorat"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="unit" value="<?= $a['unit']; ?>"
                                                             class="form-control" id="inputPassword3" placeholder="Unit"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="sub_unit" value="<?= $a['sub_unit']; ?>"
                                                             class="form-control" id="inputPassword3"
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="group" value="<?= $a['group']; ?>"
                                                             class="form-control" id="inputPassword3"
                                                             placeholder="Group"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="sub_group"
                                                             value="<?= $a['sub_group']; ?>" class="form-control"
                                                             id="inputPassword3" placeholder="Sub Group"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="group_fungsi"
                                                             value="<?= $a['group_fungsi']; ?>" class="form-control"
                                                             id="inputPassword3" placeholder="Group Fungsi"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="cost_center"
                                                             value="<?= $a['cost_center']; ?>" class="form-control"
                                                             id="inputPassword3" placeholder="Cost Center"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <input type="text" name="status_pgs"
                                                             value="<?= $a['status_pgs']; ?>" class="form-control"
                                                             id="inputPassword3" placeholder="Status PGS"
                                                             style="border: none; border-color: transparent;">
                                                  </div>
                                              </div>
                                          </div>
                                  ...
                                  <div class="tab-pane" id="timeline">
                                      <table class="table table-bordered table-hover display wrap" cellspacing="0"
                                             width="100%">
                                          <thead>
                                          <tr>
                                              <th>No</th>
