      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form method="post" action="<?php echo base_url()."index.php/searchrev/hasil_by_date";?>">
            <?php
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <form method="post" action="<?php echo base_url()."index.php/searchrev/cari_by_date2";?>">
              ...
              <tbody>
                ...
                <?php
                  ...
                  ?>
                  <tr>
                    <td><input name="pilih[]" type="checkbox" value="<?= $p['id_rev'];?>"></td>
                    <td><?= $p['id_rev'];?></td>
                    <td><?= $p['mdf'];?></td>
                    <td><?= $p['nomor_pots'];?></td>
            ...
            <!-- /.box-body -->
              <div class="box-footer" align="center">
                <button name="oke" type="submit" class="btn bg-maroon margin">Rekon</button>
              </div>
          </form>
          </div>
          <?php
