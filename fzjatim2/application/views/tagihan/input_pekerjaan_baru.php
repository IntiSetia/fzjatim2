...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?php echo base_url()."index.php/tagihan/add_pekerjaan";?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="ID Vestina" name="idv" required/>
                                    </div>
                                </div>
                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="js-example-placeholder-single js-states form-control" name="khs" id="khstelkom">
                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">KHS</label>
                                    <div class="col-sm-9">
                                        <select class="js-example-placeholder-single js-states form-control" name="khsmitra" id="khsmitra">
                                            <option value="" disabled selected>Pilih KHS</option>
                                            <?php
            ...
            <input type="submit" id="inputplan" class="btn btn-primary" style="width: 150px;" value="Submit Pekerjaan">
