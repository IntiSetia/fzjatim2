...
<!--                    <i>-</i>-->
                ...
                <div class="info-box-content">
                    ...
                    <?php
                        if (($this->session->userdata('tipe_user') == 'commerce') || ($this->session->userdata('tipe_user') == 'procurement')){
        ...
        <?php
            if (($this->session->userdata('tipe_user') == 'procurement')){
                echo "";
            } else {
        ?>
        <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <?php
                        if (($this->session->userdata('tipe_user') == 'commerce')){
