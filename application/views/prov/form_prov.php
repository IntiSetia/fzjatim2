                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="Ketikkan nomor pots" name="nomor_pots" id="pots" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="Ketikkan nomor internet" name="nomor_speedy" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" placeholder="Ketikkan nama STB" name="stb">
                                    </div>
                                </div>
                    ...
                    <div class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" type="number" placeholder="Ketikkan jumlah tiang yang digunakan" name="tiang" required/>
                                </div> batang
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="number" placeholder="Ketikkan redaman" name="hasil_cek_redaman" required/>
                                </div> dB
                            </div>
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="file" name="ba_psb">
