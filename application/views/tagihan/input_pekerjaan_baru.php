...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?php echo base_url()."index.php/tagihan/search_pekerjaan";?>" method="post" enctype="multipart/form-data">
            <div class="row" id="planpekerjaan" hidden="hidden">
                ...
                <div class="col-md-12">
                        ...
                        <div class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="jenis_pekerjaan" id="jenis">
                                            ...
                                            <?php
                                            if ($this->session->userdata('position') == "Admin Project Deployment" || $this->session->userdata('position') == "Team Leader Project Deployment" || $this->session->userdata('position') == "Site Manager Project Deployment") {
                                                ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="pekerjaan" id="plan_pek_baru"/>
                    ...
                    <input type="submit" class="btn btn-primary" style="width: 150px;" value="Pilih" id="pilih">
                </div>
            </div>
        </form>
        ...
        <form action="<?php echo base_url()."index.php/tagihan/add_pekerjaan";?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12" id="telkom">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <input style="text-align: center;" class="form-control" id="totaljumlahmitra" readonly="readonly" />
                            </div>
                        </div>
                        ...
                        <div class="box-body no-padding">
                            <table class="table table-condensed" id="addDesignatorMitra">
                                ...
                                <tr>
                                    <th style="text-align: center; width: 50px">&nbsp;</th>
                                    <td style="text-align: center; width: 284px">
                                        <select class="js-example-placeholder-single js-states form-control designator-select-mitra" pos="1" id="designatormitra" name="designatormitra[]" >
                                        </select>
                                    </td>
                                    <td style="width: 230px; text-align: center;"><input style="text-align: center;" class="form-control" type="text" pos="1" name="materialmitra" id="materialmitra1" readonly="readonly" /></td>
                                    <td style="width: 200px; text-align: center;"><input style="text-align: center;" class="form-control" type="text" pos="1" name="jasamaterial" id="jasamitra1" readonly="readonly" /></td>
                                    <td style="width: 214px; text-align: center;"><input style="text-align: center;" class="form-control volumemitra" type="text" pos="1"  name="volumemitra[]" id="volumemitra"  /></td>
                                    <td style="width: 214px; text-align: center;"><input style="text-align: center;" class="form-control" type="text" name="jumlahmitra" pos="1" id="jumlahmitra1" readonly="readonly" /></td>
                        ...
                        <div class="box-body no-padding">
                            <table class="table table-condensed">
                                <tr>
                                    <td colspan="10" align="center"><span class="fa btn btn-success fa-plus" onclick="addMoreRowsMitra();"></span></td>
                                </tr>
                            </table>
                        </div>
                    </div>
            ...
            <input type="submit" class="btn btn-primary" style="width: 150px;" value="Submit Pekerjaan" id="submit">
            ...
            <?php
            if ($_alert != NULL) {
                echo "<b><h4 class='box-title' style='color: green;'>".$_alert."</h4></b>";
            } else {
                echo " ";
            }
            ?>
