...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="<?php echo base_url() . "index.php/marshall/input_form"; ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <!-- left column -->
                    <div class="col-md-7">
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="js-example-placeholder-single js-states form-control"
                                                ...
                                                <option value="" selected>Pilih Jenis Instalasi</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- Lokasi -->
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" placeholder="Lokasi" name="lokasi"  id="latitude"/>
