...
if($this->session->userdata('position') == 'Admin Human Capital Service' || $this->session->userdata('position') == 'Team Leader Human Capital Service' || $this->session->userdata('nama') !== 'TEFANI DIVA WIBOWO' || $this->session->userdata('nama') !== 'INTI SETIA NINGTYAS' || $this->session->userdata('nama') !== 'ANDRE FIRMAN SAPUTRA' || $this->session->userdata('position') !== 'Mgr Shared Service & Performance Jawa Timur 2') {
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Form Input Hasil Pengolahan Kontrak Management

                <button type="button" id="getplan" class="btn btn-primary" style="width: 150px;" value="Get From Plan">
                    <b>Get From Plan</b></button>
                <button type="button" id="insidentil" class="btn btn-primary" style="width: 150px; display: none;"
                        value="Insidentil"><b>Insidentil</b></button>
        ...
        <section class="content">
            <form action="<?php echo base_url() . "index.php/tagihan/add_pekerjaan"; ?>" method="post"
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <input class="form-control" type="hidden"
                                               value="<?php echo $this->session->userdata('username') ?>" name="maker"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="nama_mitra" required id="plan_pek_baru"/>
                            ...
                            <div class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" placeholder="ID Project" name="idp"
                                                   required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="js-example-placeholder-single js-states form-control"
                                                    ...
                                                    id="je_pekerjaan">
                                                <option value="" style="text-decoration-color: gainsboro;">Jenis
                                                    Pekerjaan
                                                </option>
                                                <?php
                                                if ($this->session->userdata('tipe_user') == "construction") {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" placeholder="ID SPMK" name="idspmk"
                                                   required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" placeholder="Pengawas Lapangan"
                                                   name="waspang" required/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="js-example-placeholder-single js-states form-control"
                                                    name="nama_mitra" required id="namamitra"/>
                                            <option value="" selected disabled
                                            ...
                                            <option value="CV MULTIUSER GLOBAL NETWORK">CV MULTIUSER GLOBAL NETWORK
                                            </option>
                                ...
                                <table class="table table-condensed" id="addDesignator">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center; width: 284px">
                                            <select class="js-example-placeholder-single js-states form-control designator-select"
                                                    pos="0" id="designator" name="designator[]">
                                            </select>
                                        </td>
                                        <td style="width: 230px; text-align: center;"><input style="text-align: center;"
                                                                                             class="form-control"
                                                                                             type="text" pos="0"
                                                                                             name="material"
                                                                                             id="material0"
                                                                                             readonly="readonly"/></td>
                                        <td style="width: 200px; text-align: center;"><input style="text-align: center;"
                                                                                             class="form-control"
                                                                                             type="text" pos="0"
                                                                                             name="jasa" id="jasa0"
                                                                                             readonly="readonly"/></td>
                                        <td style="width: 214px; text-align: center;"><input style="text-align: center;"
                                        ...
                                        <td style="width: 214px; text-align: center;"><input style="text-align: center;"
                                                                                             ...
                                                                                             id="jumlah0"
                                                                                             readonly="readonly"/></td>
                                        <td><span class="fa btn btn-success fa-plus" onclick="addMoreRows2();"></span>
                                        </td>
                                        <th style="text-align: center">&nbsp;</th>
                                        <th style="text-align: center">&nbsp;</th>
                                    </tr>
                            ...
                            <div class="box-body no-padding">
                                <table class="table table-condensed" id="addDesignatorMitra">
                                    ...
                                    <tr>
                                        <th style="text-align: center; width: 50px">&nbsp;</th>
                                        <td style="text-align: center; width: 284px">
                                            <select class="js-example-placeholder-single js-states form-control designator-select-mitra"
                                                    pos="0" id="designatormitra" name="designatormitra[]">
                                            </select>
                                        </td>
                                        <td style="width: 230px; text-align: center;"><input style="text-align: center;"
                                                                                             class="form-control"
                                        ...
                                        <td style="width: 200px; text-align: center;"><input style="text-align: center;"
                                                                                             ...
                                                                                             readonly="readonly"/></td>
                                        <td style="width: 214px; text-align: center;"><input style="text-align: center;"
                                                                                             class="form-control volumemitra"
                                                                                             type="text" pos="0"
                                                                                             name="volumemitra[]"
                                                                                             id="volumemitra"/></td>
                                        <td style="width: 214px; text-align: center;"><input style="text-align: center;"
                                                                                             ...
                                                                                             id="jumlahmitra0"
                                                                                             readonly="readonly"/></td>
                                        <td><span class="fa btn btn-success fa-plus"
                                                  onclick="addMoreRowsMitra();"></span></td>
                                        <th style="text-align: center">&nbsp;</th>
                                        <th style="text-align: center">&nbsp;</th>
                                    </tr>
                                </table>
                ...
                <input type="submit" id="inputplan" class="btn btn-primary" style="width: 150px;"
                       value="Submit Pekerjaan">
