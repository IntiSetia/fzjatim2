    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="callout callout-danger">
                <h4>Perhatian!</h4>
                <p>1. Jadikan setiap tanggal menjadi "Date Format" dan setiap angka yang ada menjadi "Number Format"
                    (tanpa titik ataupun koma diantara angka)</p>
                <p>2. Urutan dari kolom yang harus dipenuhi, yaitu: </p>
                <br>
                <p></p>
            </div>
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <form action="<?= base_url('index.php/marshall/input_jadwal') ?>" method="post"
